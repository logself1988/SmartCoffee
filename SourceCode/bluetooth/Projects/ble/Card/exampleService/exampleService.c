...
static uint8 simpleProfileChar1UserDesp[17] = "Custom Card NO.\0";
...
static uint8 simpleProfileChar2UserDesp[17] = "RSSI Threshold.\0";
...
static uint8 simpleProfileChar3UserDesp[17] = "NFC Card NO.\0";
...
static uint8 simpleProfileChar4UserDesp[17] = "ROLE FLAGS.\0";
  ...
  if ( pAttr->type.len == ATT_BT_UUID_SIZE )
  {
    ...
    switch ( uuid )
    {
      ...
      case SIMPLEPROFILE_CHAR2_UUID:
        ...
        if ( status == SUCCESS )
        {
          VOID osal_memcpy(pAttr->pValue, pValue, 1);
